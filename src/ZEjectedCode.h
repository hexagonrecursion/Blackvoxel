...
*/
  ...
  if ( Keyboard_Matrix[SDLK_n] )  { ; SDL_ShowCursor(SDL_ENABLE); }
  if ( Keyboard_Matrix[SDLK_F2] ) { ; SDL_ShowCursor(SDL_DISABLE); }
  if ( Keyboard_Matrix[SDLK_F1] ) { ; SDL_ShowCursor(SDL_ENABLE); }
  //if ( Keyboard_Matrix[SDLK_F5] ) { World.Save(); }
  //if ( Keyboard_Matrix[SDLK_F9] ) { World.Load(); }

  if ( Keyboard_Matrix[SDLK_F12] )  { ; SDL_ShowCursor(SDL_ENABLE); exit(0); }
